...
export interface ExtractedOfferFields {
  ...
  /** Salary parsed into a monthly gross figure in local currency. */
  ...
  /** Raw text extracted from the letter — used for keyword scanning. */
...
export interface FraudFinding {
  ...
  detail: string;
  /** How the user can independently verify or address this specific concern. */
  actionable?: string;
}
...
export function detectFraudPatterns(fields: ExtractedOfferFields): FraudFinding[] {
