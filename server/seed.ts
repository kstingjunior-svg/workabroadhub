...
const CANONICAL_SERVICES = [
  ...
  { slug: "cv_rewrite",        name: "Country-Specific CV Rewrite",    price: 699,  currency: "KES", isActive: true, order: 5,  category: "CV & Documents",       badge: "Our pick",   isSubscription: false, subscriptionPeriod: null, description: "Different country, different rules. We rewrite your CV the way employers in your target country actually expect it.", features: ["Native format for UAE, UK, Canada, EU","Rewritten by a career expert who's done it","Your transferable skills front and centre","Clean, recruiter-friendly layout","Word + PDF"] },
  { slug: "cover_letter",      name: "Cover Letters That Get Read",    price: 149,  currency: "KES", isActive: true, order: 3,  category: "CV & Documents",       badge: null,           isSubscription: false, subscriptionPeriod: null, description: "Not the generic \"I am writing to apply\" nonsense. We write it like you're already in the room. ≈ 2 mandazi. Worth it.", features: ["Custom letter per role and country","Voice that sounds like a human","Handles the visa + relocation question naturally","Your best bits up top","In your inbox in minutes"] },
