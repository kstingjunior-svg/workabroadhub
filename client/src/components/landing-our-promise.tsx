...
const PROMISES = [
  ...
  },
  {
    ...
    body: "Every agency we mention is checked against the live public licence register. Every portal we link to is hand-picked from official employer sites — not directories.",
  },
  {
    icon: Compass,
