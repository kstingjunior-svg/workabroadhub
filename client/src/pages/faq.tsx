...
const categories = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. We operate in Nairobi, Kenya, and comply with the Kenya Data Protection Act 2019, National Employment Authority (NEA) guidelines, and applicable labour laws. We are a consultation service, not a recruitment agency, so recruitment agency licensing requirements do not apply to us — but we actively promote the use of licensed recruitment agencies and provide a verified agency database."
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "In most cases, no. Legitimate recruitment agencies are paid by the employer, not the worker. Charging workers upfront fees for visa processing, training, or registration is illegal under Kenyan law. The only legitimate fees are passport costs and medical examination fees, which you pay to the relevant government offices directly — not to the agency. If an agency asks for money, verify their recruitment agency licence first, and if in doubt, contact us before paying anything."
      },
      {
        q: "A company says they are licensed but I can't find them in your database. What should I do?",
        a: "Our database is updated regularly but may have a short lag. First, try searching by different spellings of the name. If you still can't find them, contact us via WhatsApp and we'll check directly with the public licence register. Do not proceed with any agency until their license is confirmed."
      },
      {
        q: "What is the Government Manual Override system?",
        a: "Occasionally, the public licence register experiences downtime. When this happens, our system automatically flags the affected period and our admins can create manual license verifications based on official documents. You'll see a downtime notice on the Recruitment Agencies page if this is active — it means data may be up to 24 hours old."
      },
    ]
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Stop all payments immediately and do not send any more documents or money. Report the scam using our Report Fraud page — we share information with the National Employment Authority and law enforcement. You should also report it to the Directorate of Criminal Investigations (DCI) Cyber Crime Unit. If you've already paid, contact your bank or M-Pesa to attempt a reversal (this has a short window). Keep all messages, receipts, and contact details as evidence."
      },
      {
