          ...
          <Card>
            <CardContent className="p-8 prose prose-sm max-w-none dark:prose-invert">
              ...
              <ul>
                ...
                <li><strong>Managed Cloud Infrastructure</strong> — Primary encrypted database and server hosting. All data is stored within our secure cloud infrastructure with encryption at rest and in transit.</li>
