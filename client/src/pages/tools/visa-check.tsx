...
export default function VisaCheckPage() {
  ...
  function handleFile(f: File | null) {
    ...
    if (!f.type.startsWith("image/")) {
      toast({ title: "Please upload an image", description: "JPG, PNG or WEBP — a clear photo of the visa works best.", variant: "destructive" });
      return;
    }
              ...
              {!preview ? (
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">JPG, PNG or WEBP · up to 10 MB · a clear photo works fine</p>
                  </div>
                </button>
              ) : (
