      ...
      <div className="max-w-xl mx-auto px-4 mt-4 space-y-4">
        ...
        {result && (
          <div className="space-y-4" data-testid="section-ats-results">
            ...
            {/* ── TRIPWIRE OFFER: KES 99 CV Fix Lite ─────────────────────
                Highest-leverage conversion moment on the whole platform.
                User has just seen their score (and any sub-70 score
                creates a real felt problem). Closing the loop INSIDE the
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        {["Grammar & spelling fix", "Professional formatting", "Structure improvement", "Word & PDF delivery"].map((f) => (
