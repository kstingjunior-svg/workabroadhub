...
export const GUIDES: Record<string, CountryGuide> = {
  ...
  "saudi-work-permit-kenya": {
    ...
    heroSubhead: "Saudi work routes go through a NEA-licensed Kenyan agency in 90% of cases. Here is the full Block Visa → Work Visa → Iqama path, what each step costs, and how to avoid the agencies that steal money.",
    ...
    steps: [
      { title: "1. Go through a NEA-licensed Kenyan agency (mandatory)", body: "By Kenyan law, you can only travel to Saudi Arabia for work via a NEA-licensed agency. Verify any agency at the National Employment Authority registry (workabroadhub.tech has our free agency checker). If they ask for more than KES 35,000 in total agency fees, walk away — that's the legal cap." },
    ...
    faqs: [
      { q: "Why must I go through a NEA-licensed Kenyan agency?", a: "Kenyan law (Labour Institutions Act) requires this for all Gulf placements. Going via informal channels is illegal AND removes your repatriation + dispute rights. The fee cap is KES 35,000 — agencies charging more are breaking Kenyan law." },
    ...
    recommendedServices: [
      ...
      { slug: "work_permit_saudi_mid", reason: "Light guide + Enjazit form pre-fill + NEA-licensed agency vetting checklist" },
