...
exports.DATA_QUALITY_REPORT_VERSION = void 0;
exports.generateDataQualityReport = generateDataQualityReport;
// ─────────────────────────────────────────────────────────────────────────────
// Versioning
// ─────────────────────────────────────────────────────────────────────────────
exports.DATA_QUALITY_REPORT_VERSION = 1;
const TOP_N = 10;
// ─────────────────────────────────────────────────────────────────────────────
// generateDataQualityReport
// ─────────────────────────────────────────────────────────────────────────────
function generateDataQualityReport(input) {
    // ── Quarantine analysis ─────────────────────────────────────────────────
    const byCode = {};
    ...
    const quarantineSamples = input.quarantined.slice(0, TOP_N).map((q) => ({
        licenseNumber: String(q.raw.licenseNumber ?? "(unknown)"),
        reasons: q.reasons,
    }));
    ...
    for (const u of input.changes.updated) {
        ...
        if (u.fieldChanges.statusSource !== undefined)
            statusFlips++;
    }
    ...
    return {
        version: exports.DATA_QUALITY_REPORT_VERSION,
