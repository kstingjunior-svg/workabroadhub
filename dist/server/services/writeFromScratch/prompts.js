...
${(0, human_voice_1.roleVerticalContext)(input.role)}
...
Task: Write a warm, specific one-page cover letter in Kenyan English${input.employerName ? ` addressed to the hiring team at ${input.employerName}` : ""}${input.targetCountry ? ` for a ${input.role} role in ${input.targetCountry}` : ""}.
...
${(0, human_voice_1.roleVerticalContext)(input.candidateRole)}
