...
exports.analyzeCareerProfile = analyzeCareerProfile;
exports.generateQuickMatch = generateQuickMatch;
const openai_1 = require("../lib/openai");
async function analyzeCareerProfile(profile, countryInsights) {
...
async function generateQuickMatch(skills, experience, education) {
    try {
        const response = await openai_1.openai.chat.completions.create({
            model: "gpt-4o-mini",
            messages: [
