...
exports.SHARED_INSTITUTION_VERIFICATION = exports.IELTS_PROVIDERS = void 0;
exports.findProvider = findProvider;
exports.IELTS_PROVIDERS = [
    {
        key: "british_council",
        ...
        notes: "British Council is the primary IELTS partner for Kenya, East Africa, UK, and parts of Asia. Kenyan candidates who booked through British Council use its portal to view results and download the eTRF.",
    },
    {
        key: "idp",
        ...
        notes: "IDP is the IELTS partner for Australia, New Zealand, Canada and much of South-East Asia. Uses the shared ORS system (ors.ielts.org) for institutional verification.",
    },
    {
        key: "ielts_usa",
        name: "IELTS USA",
        ...
        notes: "IELTS USA runs IELTS in the United States. Institutional verification is separate from the global ORS system.",
    },
    {
        key: "cambridge",
        ...
        notes: "Cambridge is the third co-owner of IELTS (with British Council + IDP). Doesn't run test centres directly.",
    },
];
/**
...
function findProvider(input = {}) {
    ...
    if (centre.includes("british council"))
        return exports.IELTS_PROVIDERS[0];
    if (centre.includes("idp"))
        return exports.IELTS_PROVIDERS[1];
    if (centre.includes("ielts usa"))
        return exports.IELTS_PROVIDERS[2];
    ...
    if (country) {
        ...
        if (bcCountries.some((c) => country.includes(c)))
            return exports.IELTS_PROVIDERS[0];
        if (idpCountries.some((c) => country.includes(c)))
            return exports.IELTS_PROVIDERS[1];
        if (usaCountries.some((c) => country.includes(c)))
            return exports.IELTS_PROVIDERS[2];
    }
    return null;
}
 ...
 */
exports.SHARED_INSTITUTION_VERIFICATION = {
