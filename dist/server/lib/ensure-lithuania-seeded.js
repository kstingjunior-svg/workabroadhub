...
exports.ensureLithuaniaSeeded = ensureLithuaniaSeeded;
/**
...
const LT_GUIDES = [
    {
        ...
        content: "Lithuania is real for Kenyans but narrow. The pipelines that actually work:\n\n" +
    ...
    {
        section: "cv_tips",
        content: "Use the European CV format (Europass is universally accepted in Lithuania). 2 pages maximum.\n\n" +
    ...
    },
    {
        ...
        content: "⚠️ READ THIS BEFORE PAYING.\n\n" +
...
async function ensureLithuaniaSeeded() {
    ...
    try {
       ...
       ON CONFLICT (code) DO UPDATE
         SET name = EXCLUDED.name,
             ...
             is_active = true
       RETURNING id`, [LT_NAME, LT_CODE, LT_FLAG]);
        ...
        console.log(`[ensureLithuania] ✓ Lithuania seeded: countryId=${countryId} ` +
