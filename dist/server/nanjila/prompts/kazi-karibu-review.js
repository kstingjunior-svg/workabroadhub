...
exports.KAZI_KARIBU_REVIEW_PROMPT_VERSION = void 0;
exports.buildKaziKaribuReviewPrompt = buildKaziKaribuReviewPrompt;
exports.parseKaziKaribuReviewResponse = parseKaziKaribuReviewResponse;
exports.KAZI_KARIBU_REVIEW_PROMPT_VERSION = "v1.0.0";
/**
 * The frozen review prompt. Emits STRICT JSON so the server can parse
 * deterministically.
 */
function buildKaziKaribuReviewPrompt(ctx) {
    const system = [
 ...
 */
function parseKaziKaribuReviewResponse(raw) {
    let obj;
    try {
