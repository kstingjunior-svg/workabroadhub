...
exports.COUNTRY_REGISTRY = [
    ...
    // ══════════════════════════════════════════════════════════════════════
    {
        ...
        nextStepAdvice: "For UAE work visas, verify the employer's establishment card via MOHRE's Tas'heel portal + the visa file number on the ICP smart services validity checker. A real UAE work visa is always tied to an employer's Labour Card — if the sponsor won't share their establishment number, walk away.",
        knownScamPatterns: [
    ...
    },
    {
        ...
        nextStepAdvice: "For Saudi work visas (Iqama), verify via Musaned (domestic workers) or Qiwa (professional workers). Every real Saudi work visa has a Border Number, Visa Number, and Sponsor Iqama — if any are missing, the visa is not enforceable at the airport. Confirm the employer is registered on Qiwa before travel.",
        knownScamPatterns: [
    ...
    },
    {
        ...
        nextStepAdvice: "For Qatar work visas, use the Metrash2 app OR the MOI portal to verify. Real Qatar work visas require: (1) valid QID number after entry, (2) contract deposited with ADLSA, (3) sponsor's Commercial Registration. Ask for all three before paying anything.",
    },
    {
        code: "OM",
        name: "Oman",
        ...
        nextStepAdvice: "For Oman work visas, verify via the Royal Oman Police eVisa portal. All work visas must be pre-approved by the Ministry of Manpower — confirm the employer holds a Labour Clearance Certificate before travel.",
    },
    {
        code: "KW",
        name: "Kuwait",
        ...
        nextStepAdvice: "For Kuwait work visas (Article 18 or 20), verify via the MOI e-services portal using your Civil ID. All work visas require the sponsor to hold a valid Commercial Licence + PAM approval — confirm both before travel.",
    },
    {
        code: "BH",
        name: "Bahrain",
        ...
        nextStepAdvice: "For Bahrain work visas, verify via LMRA (Labour Market Regulatory Authority). Every legitimate work visa has an LMRA number and requires the employer to hold a valid CR (Commercial Registration).",
    },
    // ══════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════
    {
        ...
        nextStepAdvice: "UK Skilled Worker visas require your employer to be on the UK Government's public Register of Licensed Sponsors — check that list before accepting any UK job offer. Care worker visas require the sponsor's CQC registration in addition. Never pay a sponsor for your Certificate of Sponsorship (CoS) — that is illegal.",
        knownScamPatterns: [
    ...
    },
    {
        ...
        nextStepAdvice: "Canadian work permits require a valid LMIA (Labour Market Impact Assessment) OR LMIA-exempt category. Log into your IRCC account (or create one) and verify the application number matches. Real Canadian work permits show your UCI (Unique Client Identifier) — a permit without a UCI is fraudulent.",
        knownScamPatterns: [
    ...
    },
    {
        ...
        nextStepAdvice: "US work visas (H-1B, H-2B, EB categories) require an approved I-129 or I-140 petition from USCIS. Check the case status at egov.uscis.gov using the receipt number. Real US work visas are stamped in your passport by the US Embassy — no legitimate US visa is issued by any agent outside the embassy.",
    },
    {
        code: "AU",
        name: "Australia",
        ...
        nextStepAdvice: "Australian work visas (482, 494, 186, WHV) can be verified via VEVO (Visa Entitlement Verification Online). Real Australian visas are issued electronically — there is NO visa sticker or foil. If someone shows you a sticker or physical visa document as \"proof\", it is fake.",
    },
    {
        code: "NZ",
        name: "New Zealand",
        ...
        nextStepAdvice: "New Zealand visas are issued electronically via the eVisa system. Check the AEWV (Accredited Employer Work Visa) status via your INZ online account. Only Licensed Immigration Advisers (LIAs) can legally give NZ immigration advice for a fee — verify their licence at iaa.govt.nz.",
    },
    // ══════════════════════════════════════════════════════════════════════
    // EUROPEAN
    // ══════════════════════════════════════════════════════════════════════
    ...
    },
    {
        ...
        nextStepAdvice: "Dutch highly-skilled migrant visas require your employer to be on the IND Public Register of Recognised Sponsors — check that list before signing anything. The visa itself is issued as a Dutch residence card (verblijfsvergunning) upon arrival.",
    },
    {
        code: "IE",
        name: "Ireland",
        ...
        nextStepAdvice: "Ireland's Critical Skills + General Employment Permits are issued by the Department of Enterprise, not the embassy. Verify your permit number on the DBEI Employment Permits Online System. The permit AND a valid Irish visa (issued by the embassy) are both required.",
    },
    {
        code: "PL",
        name: "Poland",
        ...
        nextStepAdvice: "Polish work visas require both a Voivode's Work Permit (Zezwolenie na pracę) AND a national visa (Type D) issued by the Polish Embassy. The work permit is filed BY THE EMPLOYER in Poland — you cannot obtain one yourself. Confirm your employer has filed before paying anything.",
    },
    {
        code: "LU",
        name: "Luxembourg",
        ...
        nextStepAdvice: "Luxembourg salaried worker (\"salarié\") visas require a temporary authorization to stay (autorisation de séjour temporaire) issued BEFORE you travel. The employer must first prove no EU citizen is available for the role. Verify with the Immigration Directorate at immigration.mae@mae.etat.lu.",
    },
    // ══════════════════════════════════════════════════════════════════════
    // ASIA-PACIFIC
    // ══════════════════════════════════════════════════════════════════════
    {
        ...
        nextStepAdvice: "Turkish work visas require a work permit (Çalışma İzni) from the Ministry of Labour BEFORE the visa can be issued by the embassy. The employer submits the work permit application — verify it exists via ecalismaizni.csgb.gov.tr.",
    },
    {
        code: "JP",
        name: "Japan",
        ...
        nextStepAdvice: "Japanese work visas require a Certificate of Eligibility (CoE) issued by the Immigration Services Agency BEFORE the visa can be applied for. The employer files the CoE — request a scan of it before paying anything.",
    },
    {
        code: "KR",
        name: "South Korea",
        ...
        nextStepAdvice: "South Korean EPS (Employment Permit System) workers apply through their home country's HRD Korea office — Kenya is NOT currently an EPS partner country. Any \"guaranteed EPS visa from Kenya\" offer is a scam. E-9 work visas from Kenya are not directly available.",
    },
    {
        code: "SG",
        name: "Singapore",
        ...
        nextStepAdvice: "Singapore work visas (Employment Pass, S Pass, Work Permit) are issued by MOM (Ministry of Manpower). The employer applies — you cannot apply yourself. Verify your employer via MOM's Employment Agency Directory. Every legitimate Singapore work pass has a FIN number after arrival.",
    },
    {
        code: "MY",
        name: "Malaysia",
        ...
        nextStepAdvice: "Malaysian work visas (Employment Pass, Professional Visit Pass) require sponsorship approval from ESD (Expatriate Services Division). Confirm the employer is registered with ESD before travel.",
    },
    // ══════════════════════════════════════════════════════════════════════
    // NEW / TRENDING
    // ══════════════════════════════════════════════════════════════════════
    {
        ...
        nextStepAdvice: "The Bahamas issues an Electronic Entry Visa through the Ministry of Foreign Affairs. Public verification is NOT available online — contact the Bahamas MFA directly with your visa number to confirm. Work permits are separately issued by the Department of Immigration.",
    },
    {
        code: "PT",
        name: "Portugal",
        ...
        nextStepAdvice: "Portuguese work visas (D2 job-seeker, D3 highly-qualified) are issued by AIMA. Every legitimate work visa requires an NIF (tax number) and either a job offer or a manifestation of interest — verify through the Portuguese consulate.",
    },
];
/**
...
function findCountry(input) {
    ...
    if (!needle)
        return null;
    for (const c of exports.COUNTRY_REGISTRY) {
        if (c.code.toLowerCase() === needle)
            return c;
        if (c.name.toLowerCase() === needle)
            return c;
        if (c.aliases.some((a) => a.toLowerCase() === needle))
            return c;
        // Also match if needle CONTAINS the country name (e.g. "issued in the united arab emirates")
        if (needle.includes(c.name.toLowerCase()))
            return c;
        for (const alias of c.aliases) {
            if (alias.length >= 3 && needle.includes(alias.toLowerCase()))
                return c;
        }
    }
    return null;
...
function getSupportedCountries() {
    return exports.COUNTRY_REGISTRY.slice();
}
