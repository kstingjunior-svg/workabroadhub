...
(async () => {
    try {
        ...
        try {
            const { registerHubRoutes, bootstrapHubSchema } = await Promise.resolve().then(() => __importStar(require("./routes/hub")));
            ...
            bootstrapHubSchema()
                ...
                .catch((e) => console.error("[Server] ❌ Hub schema bootstrap failed:", e?.message));
        }
        catch (err) {
