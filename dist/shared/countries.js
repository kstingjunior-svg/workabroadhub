...
exports.SUPPORTED_COUNTRY_NAMES = exports.SUPPORTED_COUNTRIES = void 0;
exports.findCountryBySlug = findCountryBySlug;
...
// ─── Helpers ─────────────────────────────────────────────────────────────
exports.SUPPORTED_COUNTRY_NAMES = exports.SUPPORTED_COUNTRIES
    .filter((c) => c.isActive)
    .map((c) => c.name);
function findCountryBySlug(slug) {
    const s = slug.toLowerCase();
    return exports.SUPPORTED_COUNTRIES.find((c) => c.slug === s);
}
function findCountryByName(name) {
    const n = name.toLowerCase();
    return exports.SUPPORTED_COUNTRIES.find((c) => c.name.toLowerCase() === n);
}
