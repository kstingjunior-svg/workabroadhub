...
exports.NAIROBI_BASELINE_KES = exports.COST_OF_LIVING = void 0;
exports.sumCosts = sumCosts;
exports.getDestinationLabel = getDestinationLabel;
const salary_intelligence_1 = require("./salary-intelligence");
const FX = {
    AED: 35,
    SAR: 35,
    QAR: 36,
...
function getDestinationLabel(countryCode) {
    return salary_intelligence_1.SUPPORTED_SALARY_COUNTRIES.find((c) => c.code === countryCode)?.name ?? countryCode;
}
