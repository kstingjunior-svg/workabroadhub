...
exports.SERVICE_SLA = void 0;
exports.getServiceSLA = getServiceSLA;
...
function getServiceSLA(serviceName) {
    const sla = exports.SERVICE_SLA[serviceName];
    if (sla)
        return sla;
    return {
        hours: 24,
