...
export interface AfricanCountry {
  ...
  timezoneHint: string;
  /** Broad region — Africa (north/west/east/central/southern), Gulf,
      Europe, Asia, Americas, Oceania, Caribbean. WorkAbroadHub started
      Kenya-first, expanded to Gulf where diaspora already works, then
      to the whole world (2026-08) — anyone can now register from
      anywhere and pay via PayPal. */
  region:
    | "north" | "west" | "east" | "central" | "southern"
    | "gulf" | "europe" | "asia" | "americas" | "oceania" | "caribbean";
}
